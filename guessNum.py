...
class GuessTheNumberApp:
    def __init__(self, root):
        ...
        self.title_label = tk.Label(self.main_frame, text='Welcome to Guess the Number!', font=('Arial', 14, 'bold'), anchor='w')
        self.title_label.grid(row=0, column=0, columnspan=2, sticky='ew', pady=(0, 8))

        self.instruction_label = tk.Label(self.main_frame, text='Guess a number between 1 and 100.', anchor='w')
        ...
        self.feedback_label = tk.Label(self.main_frame, text='', font=('Arial', 11), fg='blue', anchor='w')
